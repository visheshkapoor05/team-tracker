...
export function BrandRegistry({
  ...
  return (
    <section className="rounded-xl border border-line bg-surface p-5">
      <h2 className="mb-1 text-sm font-semibold text-ink">Brand Registry</h2>
      ...
      <div className="mb-4 flex items-center gap-2">
        <input
          ...
          className="max-w-xs flex-1 rounded-md border border-line px-2 py-1.5 text-sm outline-none focus:border-indigo-400"
        />
        <button
          onClick={addNew}
