...
export function SignupForm() {
  ...
  if (sent) {
    return (
      <div className="w-full max-w-sm rounded-xl border border-line bg-surface p-6 text-center shadow-sm">
        <h2 className="mb-2 text-sm font-semibold text-ink">Check your email</h2>
